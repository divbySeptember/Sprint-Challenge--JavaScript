...
const tyrannosaurus = new Dinosuar({
  name: 'Tyrannosauros' ,
  diet: 'carnvourous' ,
  weight: 7000 + ' kg' ,
  length: 12 + ' m' ,
...
const stegosaurus = new Dinosuar({
  name: 'Stegosaurus' ,
  diet: 'herbivourous' ,
  weight: 2000 + ' kg' ,
  length: 9 + ' m' ,
...
const velociraptor = new Dinosuar({
  name: 'Velociraptor' ,
  diet: 'carnvourous' ,
  weight: 15 + ' kg' ,
  length: 1.8 + ' m' ,
...
Dinosuar.prototype.roar = function () {
...
const lowerCase = zooAnimals.map((state) => {
  return {'first_name': state.animal_name.toLowerCase()};
